...
public class ModdedTileEntities {
    ...
    public static final RegistryObject<TileEntityType<DebugEnergySourceTile>> debug_energy_source = TILE_ENTITIES.register("debug_energy_source", () -> TileEntityType.Builder.of(DebugEnergySourceTile::new, ModdedBlocks.debug_energy_source.get()).build(null));
}
